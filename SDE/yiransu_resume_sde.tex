...
\section{Intern Experience}
  ...
  \resumeItemListStart
  \resumeItem
  {C-PAC is a configurable processing pipeline for functional brain MRI data. My work is focusing on the configurable frontend, using \textbf{React.js} (JavaScript) with React-Redux and React-Saga.}
  \resumeItemListEnd
