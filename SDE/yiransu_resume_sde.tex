...
\section{Project Experience}
	...
	\resumeItem
	{A full stack project that requires both frontend (web/Andriod/ReactNative) and backend (response framework /database) implementation. The project goal is to help people connect with nearby book readers.}
	\resumeItem
	{Backend: \textbf{MVC} structured \textbf{Flask} \& \textbf{Flask-RESTful} (\textbf{Python}). \textbf{Firebase} and \textbf{PyMongo} for database. }
	\resumeItem
	{Accomplished a \textbf{web} frontend with \textbf{HTML/CSS/Bootstrap} and embedded it into our Flask-RESTful backend.}
	\resumeItem
	{Applied \textbf{Kotlin} for the \textbf{Android} frontend. Designed a \textbf{reusable cardview template} for the team. \textbf{Volley} to handle requests. Kotlin's \textbf{Camera \& Location API} applied.  }
	\resumeItem
	{\textbf{React Native} frontend with \textbf{Expo}. APIs include camera, location, sharing (social media) and notification.  }
	\resumeItemListEnd
	
	\internSubheading{Sun Yat-sen University Club Information Platform}{Mar 2018 - Jun 2018}
	\resumeItemListStart
	\resumeItem{Designed the app to assist university clubs to spread their event information. Participated as frontend engineer.}
